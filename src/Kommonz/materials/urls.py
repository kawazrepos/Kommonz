...
from views import MaterialDetailView, MaterialCreateView, MaterialExtendFormView
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<pk>\d+)/form/$', MaterialExtendFormView.as_view(),             name="materials_material_extend_form"),
